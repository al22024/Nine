    ...
    public UserAndProjectInfo getVoteInfo(int projectID) {
        ...
        try {
            ...
            while(rs.next()) {
	            ...
	            this.genreList.add(rs.getString("Genre"));
	            this.budget1List.add(rs.getString("Budget1"));
	            this.budget2List.add(rs.getString("Budget2"));
	            this.reviewList.add(rs.getString("Review"));
            }
